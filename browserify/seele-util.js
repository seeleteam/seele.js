 ...
 */
  ...
  function clone(configObject) {
    ...
    P.exponentiatedBy = P.pow = function (n, m) {
      ...
      // Allow NaN and 卤Infinity, but not other non-integers.
      if (n.c && !n.isInteger()) {
        throw Error
      ...
      // If x is NaN, 卤Infinity, 卤0 or 卤1, or n is 卤Infinity, NaN or 卤0.
      ...
      // Overflow to 卤Infinity: >=2**1e10 or >=1.0000024**1e15.
      // Underflow to 卤0: <=0.79**1e10 or <=0.9999975**1e15.
        ...
        // If n is negative return 卤0, else return 卤Infinity.
...
},{}],"seele-util.js":[function(require,module,exports){
